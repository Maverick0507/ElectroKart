                    ...
                    <div className="h-[100%] w-[60%] bg-white px-10 sm:w-full sm:mt-4">
                        ...
                        <div className=' flex gap-5  items-center my-5 sm:flex-wrap'>
                            ...
                            {product?.colors?.map((i) => (
                                <p className=' capitalize hover:cursor-pointer hover:bg-gray-400 hover:text-white hover:border-white ease-in duration-200  border-2 border-black rounded-md p-[5px] '>{i}</p>
                            ))}
                        </div>
                        ...
                        <div className=" flex flex-col gap-10 my-9">
                            <div className=" flex gap-10 w-[70%] lg:w-[90%] md:w-full md:flex-col">
                                <div>
                                    <Button
                                        onClick={() => setQuantity(quantity - 1)} className=' rounded-none bg-white border-1 l'>-</Button>

                                    <Button
                                        className=' rounded-none'>{quantity}</Button>
                                    <Button
                                        onClick={() => setQuantity(quantity + 1)} className=' rounded-none bg-white border-1'>+</Button>

                                </div>
                                <Button className=' p-5 rounded-none'>Add to cart</Button>
                            </div>
